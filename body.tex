...
and Time (LSST)\cite{Ivezic19}, multiple teams within the observatory have been working towards
...
Exposure Breakdown applet [Fig ~\ref{fig:exposurebreakdown}]
...
applet [Fig ~\ref{fig:timeaccounting}], to add detail to events that occurred during the available observing time and
...
shown: the planned final depth of LSST survey\cite{Ivezic19}, the moon and sun coordinates, the
...
component of the control software. With this new telemetry data collected from the EFD
 ...
 Time Accounting applet [Fig ~\ref{fig:timeacc}], Time Loss card [Fig ~\ref{fig:timeloss}],
